                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6 bg-white">
                        ...
                        <div class="w-full px-3">
                            ...
                            <input type="file" multiple accept="image/*" name="file[]" class="block w-full bg-gray-200 text-gray-700 border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-red-500">
