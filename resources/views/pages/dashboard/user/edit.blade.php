                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6 bg-white">
                        ...
                        <div class="w-full px-3 mb-6">
                            ...
                            <input type="text" value="{{ old('name') ?? $user->name }}" name="name" class="block w-full bg-gray-200 text-gray-700 border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-red-500">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6 bg-white">
                        ...
                        <div class="w-full px-3">
                            ...
                            <input name="email" class="block w-full bg-gray-200 text-gray-700 border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-red-500" value="{{ old('email') ?? $user->email }}" ></input>
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6 bg-white">
                        ...
                        <div class="w-full px-3">
                            ...
                            <select name="roles" class="block w-full bg-gray-200 text-gray-700 border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-red-500">
